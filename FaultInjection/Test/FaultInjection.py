...
import FaultInjection.BasicTest.Tempest as Tempest
import FaultInjection.Requirement as Requirement
...
class FaultInjection():
    ...
    def testfun1(self):
        if "tempest" not in Common.CONFIG:
            raise nose.SkipTest('Tempest required to verify service restart')
